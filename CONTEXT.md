...
| **Template** | A reusable checklist blueprint for creating PM Tasks. Can be a **Personal Template** (scoped strictly to the creating user) or a **Default Template** (system-provided, currently globally available). |
